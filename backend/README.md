...
Installera beroenden (kräver Python):


För att installera Python, ladda ned senaste versionen från https://www.python.org/downloads/.
...
Kör API:t med antingen:

uvicorn app.main:app --reload
eller (genväg):
python -m app.main

Testa endpoints i t.ex. Swagger UI på
